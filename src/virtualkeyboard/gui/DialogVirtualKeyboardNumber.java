 ...
 */
public class DialogVirtualKeyboardNumber extends javax.swing.JDialog {

    /** Creates new form DialogVirtualKeyboard */
    public DialogVirtualKeyboardNumber(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    /** Creates new form DialogVirtualKeyboard */
    public DialogVirtualKeyboardNumber(java.awt.Frame parent, boolean modal, JTextComponent textComponent) {
        super(parent, modal);
        this.setUndecorated(true);
        initComponents();
        ...
        this.show(textComponent, textComponent.getWidth()*3, textComponent.getHeight());
    }
    ...
    private void initComponents() {
        ...
        panelVirtualKeyboard = new virtualkeyboard.gui.PanelVirtualKeyboardNumber();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogVirtualKeyboardNumber dialog = new DialogVirtualKeyboardNumber(new javax.swing.JFrame(), true);
    ...
    private virtualkeyboard.gui.PanelVirtualKeyboardNumber panelVirtualKeyboard;

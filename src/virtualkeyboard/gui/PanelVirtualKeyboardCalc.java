 ...
 * @since 01.01.2013
 */
public class PanelVirtualKeyboardCalc extends javax.swing.JPanel {
    ...
    public PanelVirtualKeyboardCalc() {
...
//              jBSpace.setText(keyBundle.getString(KeyEnums.jBSPACE_1.toString()));  //Space Key
  ...
  protected void paintComponent( Graphics g )
  {
        ...
        jBR4B11.setBounds(x, y, width, height);
            x += width+gap;
        jBExe.setBounds(x, y, width, height);
            x += width+gap;
     }
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(189, 199));
